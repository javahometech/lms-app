...
import com.jm.lms.studentms.repository.CourseDetailsRepository;
...
public class CourseDetailsService {
	...
	public CourseDetails updateCourseDetailsById(Long id, CourseDetails courseDetails) {
        CourseDetails existingCourse = courseDetailsRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("Course not found with id: " + id));
        ...
        return courseDetailsRepository.save(existingCourse);
	...
	public CourseDetails updateCourseDetailsByFields(Long id, Map<String, Object> fields) {
		 Optional<CourseDetails> existingOrder = courseDetailsRepository.findById(id);
	        ...
	        Field field =  ReflectionUtils.findField(CourseDetails.class, key);
	          ...
	          ReflectionUtils.setField(field,existingOrder.get(),val);
	           ...
	           return courseDetailsRepository.save(existingOrder.get());
	        }
